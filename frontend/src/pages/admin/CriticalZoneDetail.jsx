                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-800">
                      Детальная информация о критических зонах будет доступна в следующих версиях системы.
                      В данный момент отображаются только базовые данные.
                    </p>
                  </div>
                </div>
              </div>
...
export default CriticalZoneDetail;
